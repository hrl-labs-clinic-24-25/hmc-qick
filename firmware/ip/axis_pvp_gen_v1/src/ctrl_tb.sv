...
/***
 ...
 // Instatiation of lab 1's top module
   `timescale 10ns/1ns
    ...
    logic sendorload_o, mux_en_o, load;
 ...
 initial
   begin
    ...
    initial begin
		...
		// 5. values are given but resetn is also enabled
	...
	#20;
	if (dac_4_o == 24'b010101010101010101010101 && dac_3_o == 24'b110011001100110011001100 && dac_2_o == 24'b111100001111000011110000 && dac_1_o == 24'b111111111111000000000000 && mux_1_o == 0 && mux_2_o == 0 && mux_3_o == 0 && mux_4_o == 0 ) begin
        #1; 
            $display("Testbench ran successfully");
      end else begin
        #1; // Delay to make sure that the answer is held correctly on the cyphertext before shifting out
        $display("Error 5: DAC 1 = %h, DAC 2 = %h, DAC 3 = %h, DAC 4 = %h", dac_1_o, dac_2_o, dac_3_o, dac_4_o );
	  end

	  mem_i = 98'b1_0_010101010101010101010101_110011001100110011001100_111100001111000011110000_111111111111000000000000;
	  rstn = 0;
	#20;
	if (dac_4_o == 0 && dac_3_o == 0 && dac_2_o == 0 && dac_1_o == 0 && mux_1_o == 0 && mux_2_o == 0 && mux_3_o == 0 && mux_4_o == 0 ) begin
        #1; 
            $display("Testbench ran successfully");
      end else begin
        #1; // Delay to make sure that the answer is held correctly on the cyphertext before shifting out
        $display("Error 6: Everything should be 0" );
	  end
end
